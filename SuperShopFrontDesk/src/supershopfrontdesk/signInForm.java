...
public class signInForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pfPassward, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(102, 102, 102)
                .addComponent(bSignIn, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/supershopfrontdesk/signIn.jpg"))); // NOI18N
    ...
    private void bSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSignInActionPerformed
         ...
         String sql="SELECT * FROM  `accinfo` WHERE  `userName` LIKE  '"+tfUserName.getText()+"' AND `type` LIKE  'Cashier' AND  `password` =  '"+pass+"'";
            ...
            try{
                ...
                if(rs.next()){
                    SellPage obj1 = new SellPage();
                    obj1.setVisible(true);
                    obj1.cashier_name=tfUserName.getText();
                    obj1.tfname.setText(obj1.cashier_name);
                    setVisible(false);
                }
                else{
